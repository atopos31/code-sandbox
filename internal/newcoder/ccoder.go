...
func NewCCoder(cppCode string) Coder {
...
func (c *CCoder) Build(sandbox *sandbox.Sandbox) (*model.BuildMeta, error) {
...
// 并行运行程序
func (c *CCoder) Run(sandbox *sandbox.Sandbox, stdin string, MaxTime float64, MaxMem int, meta chan<- model.RunMeta) error {
