...
type CppCoder struct {
	basePath      string // coder基本路径 /root/project/sandbox/{uuid}
...
func (c *CppCoder) Build(sandbox *sandbox.Sandbox) (*model.BuildMeta, error) {
...
// 并行运行程序
func (c *CppCoder) Run(sandbox *sandbox.Sandbox, stdin string, MaxTime float64, MaxMem int, meta chan<- model.RunMeta) error {
