...
func (c *CPPCoder) SetSandbox(sandbox *sandbox.Sandbox) {
	c.sandbox = sandbox
}
...
func (c *CPPCoder) Run(MaxTime float64, MaxMem int, stdin string) (*model.CodeMETA, error) {
